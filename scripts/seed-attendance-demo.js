...
const ensureModule = async ({ module_name, level, school_id }) => {
  ...
  const [result] = await pool.execute(
    ...
    [module_name, 'Software Development', 120, `${module_name} for ${level}`, 'Computer Lab', school_id]
  );
  return result.insertId;
};
...
const run = async () => {
  ...
  const teachers = [
    {
      ...
      level: 'Level 3',
      prefix: 'SWD3A',
      modules: ['Computer Essentials', 'Introduction to Programming', 'Web Design Basics']
    },
    {
      name: 'Teacher One',
      email: 'teacher1@school.com',
      ...
      level: 'Level 4',
      prefix: 'SWD4A',
      modules: ['Programming Fundamentals', 'Database Systems', 'Backend Application Development']
    },
    {
      name: 'Teacher One',
      email: 'teacher1@school.com',
      ...
      level: 'Level 5',
      prefix: 'SWD5A-T1',
      modules: ['Front-End App Development', 'Mobile App Development', 'Software Testing']
    },
    {
      name: 'Claude',
      ...
      level: 'Level 5',
      prefix: 'SWD5A',
      modules: ['Data Structure and Algorithm Fundamentals', 'Front-End App Development', 'Mobile App Development', 'UI/UX Design']
    }
  ];
  ...
  for (const teacher of teachers) {
    ...
    for (const module_name of teacher.modules) {
      const module_id = await ensureModule({ module_name, level: teacher.level, school_id });
