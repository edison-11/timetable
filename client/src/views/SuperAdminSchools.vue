...
const viewSchoolData = (school) => {
  localStorage.setItem('selectedSchoolId', String(school.school_id))
  localStorage.setItem('selectedSchoolName', school.school_name || 'Selected school')
  router.push({ path: '/timetable', query: { school_id: school.school_id } })
}
