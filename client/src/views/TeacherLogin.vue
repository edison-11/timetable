<template>
  <div :class="['min-vh-100 d-flex align-items-center justify-content-center p-3', { 'teacher-dark-mode': isDarkMode }]" style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%);">
    <div class="bg-white rounded-3 shadow-lg w-100" :class="{ 'dark-card': isDarkMode }" style="max-width: 400px;">
