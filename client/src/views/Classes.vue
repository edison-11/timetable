  ...
  <AppLayout>
    <div class="classes-container">
      ...
      <div v-if="showForm" class="form-card">
        ...
        <form class="class-form" @submit.prevent="saveClass">
          ...
          <div>
            ...
            <input v-model="classForm.academic_year" class="form-control" required placeholder="2024-2025">
          </div>
          <div>
          ...
          <div>
            ...
            <select v-model="classForm.section_id" class="form-control">
          ...
          <div>
            ...
            <select v-model="classForm.dos_id" class="form-control">
              ...
              <option v-for="dosItem in dosList" :key="dosItem.dos_id" :value="dosItem.dos_id">
                {{ dosItem.name }}
              </option>
            </select>
          </div>
      ...
      <div class="filters-bar">
        ...
        <select v-model="academicYearFilter" class="filter-select">
...
const academicYearOptions = computed(() => uniqueSorted(classesList.value.map(cls => cls.academic_year)))
...
const deleteClass = async (cls) => {
  ...
  try {
    ...
    classesList.value = classesList.value.filter(item => item.class_id !== cls.class_id)
